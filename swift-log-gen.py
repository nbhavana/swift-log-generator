...
#This program creates a log for number of entries in an output file. The log has 22 
#fields seperated by space as follows:

#f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21 f22

#f1 = month, f2 = day, f3 = hour/min/sec, f4 = node, f5 = process, f6 = ip address 1,
# f7 = ip address 2, f8 = day/month/year/hour/mins/secs, f9 = method, f10 = url,
# f11 = HTTP/1.0, f12 = response code, f13 = referer, f14 = user agent, f15 = auth_token,
#f16 = bytes received, f17 = bytes sent, f18 = etag, f19 = transaction id, f20 = logged hdrs,
#f21 = time taken, f22 = source
...
if __name__ == "__main__":
    ...
    parser.add_argument("-n",required = True,action = "store",dest = "num",help = "number of log entries",type=int)
    parser.add_argument("-o",required = True,action = "store",dest = "fname",help = "name of output file")
    result = parser.parse_args(sys.argv[1:])
    num_of_log_entries = result.num
